...
function injectTransformCommand(options) {
    createCommand(options.program, {
        ...
        const logger = new Logger(args.debug ? 3 /* LogLevelKind.DEBUG */ : args.verbose ? 2 /* LogLevelKind.VERBOSE */ : args.silent ? 0 /* LogLevelKind.NONE */ : 1 /* LogLevelKind.INFO */);
        // Inform about the log level (if applicable)
        if (logger.logLevel === 2 /* LogLevelKind.VERBOSE */) {
            logger.verbose(`Logging mode: VERBOSE`);
        }
        else if (logger.logLevel === 3 /* LogLevelKind.DEBUG */) {
